                                ...
                                <div class="form-row">
                                    <div class="col-md-10 ml-3">
                                        <div class="form-group m-0">
                                            ...
                                            <input name="no_of_parts" placeholder="Enter Number Of Parts Here" class="form-control r-0 light s-12 " type="number" min="0" oninput="validity.valid||(value='');"  id="no_of_parts" required type="number" min="1">
                                        </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-10 ml-3">
                                        <div class="form-group m-0">
                                           ...
                                           <select id="select" name="class_icon" class="form-control r-0 light s-12 ">
...
<script type="text/javascript">
    //https://github.com/FortAwesome/Font-Awesome/blob/master/js-packages/%40fortawesome/fontawesome-free/metadata/icons.yml
