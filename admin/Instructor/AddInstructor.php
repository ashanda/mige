                                ...
                                <div class="form-row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group m-0">
                                            ...
                                            <input name="username" placeholder="Enter User Name" id="name" class="form-control r-0 light s-12 " type="text" required>
                                        </div>
                                         <div class="form-group m-0">
                                            <label for="Email" class="col-form-label s-12">Email</label>
                                            <input name="email" placeholder="Enter Email" class="form-control r-0 light s-12 "  id="email" type="email" required>
                                        </div>
                                        <!--  <div class="form-group m-0">
                                        ...
                                        <div class="form-group m-0">
                                            ...
                                            <textarea class="form-control" name="about" id="about" placeholder="About..." rows="7" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
