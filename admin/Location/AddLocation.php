...
if(isset($_POST['submit']))
{
    ...
    {
    $add_location = add_location($location,$latitude,$longitude,$location_detail,$creation_time);
    // if($latitude&&$longitude)
    // {
        if($add_location)
        {
        ...
        {
            $error = 'There is someting wrong while adding location';
        }
    }
    else
    {
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    ...
                    <li>
                        <a class="nav-link act"  href="#" ><i class="icon icon-plus-circle"></i> Add New Location</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-8">
                                        <div class="form-group m-0">
                                            ...
                                            <input name="location" id="location" placeholder="Enter Location Here..." class="form-control r-0 light s-12 " type="text" required>
                                            <input name="latitude" id="latitude" class="form-control r-0 light s-12 " type="hidden" required>
                                            <input name="longitude" id="longitude" class="form-control r-0 light s-12 " type="hidden" required>
                                        </div>
                                        <div class="form-group m-0">
                                            <label for="name" class="col-form-label s-12">Detail</label>
                                            <textarea class="form-control" name="location_detail" placeholder="Enter Location Detail Here..." rows="7" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
