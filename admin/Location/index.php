...
$count = count($get_location_list);
include('../includes/pagination.php');
$records=array_slice($get_location_list, $start,$limit);
                                ...
                                <form>
                                    <table class="table table-striped table-hover r-0">
                                        ...
                                        <?php foreach ($records as $key) 
                                        {
                                            ...
                                            $location_detail = $key['location_detail'];
                                            $id = $key['id'];
                                            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="EditLocation.php?id=<?php echo $id;?>"><i class="icon-pencil iconspace"></i></a>
