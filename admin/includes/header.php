...
<script src="https://staging.lyndonmarine.com/bower_components/jquery/dist/jquery.min.js"></script> 
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <span>Courses</span><i
                    class="icon icon-angle-left s-18 pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="../Course/index.php?course_type=3"><i class="icon icon-circle-o"></i>
                   <span>Active Courses</span></a>
                    </li>
                     <li><a href="../Course/CancelCourse.php"><i class="icon icon-circle-o"></i>
                    <span>Cancelled/Removed Courses</span></a>
                    </li>
            ...
            <li class="treeview">
                    ...
                    <a href="../Config/ChangePassword.php"><i class="icon icon-security s-18"></i>
            ...
            <li class="treeview">
                    ...
                    <a href="../logout.php"><i class="icon icon-sign-out s-18"></i>
                    <span>Logout</span></a>
