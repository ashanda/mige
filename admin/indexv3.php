...
$title_name_in_english = $inenglish[41];
$name_title_in_english = $inenglish[36];
$email_title_in_english = $inenglish[20];
$phone_title_in_english = $inenglish[22];
$DOB_title_in_english = $inenglish[21];
$Place_to_go_title_In_English = $inenglish[3];
$Place_to_go_Option_1_title_In_English=$inenglish[42];
$Place_to_go_Option_2_title_In_English=$inenglishCat[2];
$Place_to_go_Option_3_title_In_English=$inenglishCat[0];
$Place_to_go_Option_4_title_In_English=$inenglishCat[1];
$Place_to_go_Option_5_title_In_English=$inenglishCat[3];
$Category_title_In_English = $inenglish[24];
$Category_Option_1_title_In_English=$inenglish[34];
$Category_Option_2_title_In_English=$inenglishCategory[0];
$Category_Option_3_title_In_English=$inenglishCategory[1];
$Category_Option_4_title_In_English=$inenglishCategory[2];
$Category_Option_5_title_In_English=$inenglishCategory[3];
$Available_title_In_English = $inenglish[9];
$Select_days_title_In_English = $inenglish[4];
$Message_title_In_English = $inenglish[38];
$Available_Timings_Option_1_title_In_English= $inenglish[31];

$Available_Timings_Option_2_title_In_English = $inenglish[0];
$Available_Timings_Option_3_title_In_English = $inenglish[1];
$Available_Timings_Option_4_title_In_English = $inenglish[2];

$Available_Timi_Option_2_title_In_English = $inenglish[32];
$Available_Timi_Option_3_title_In_English = $inenglish[33];
$Available_Timi_Option_4_title_In_English = $inenglis[4];

$Select_Days_Option_1_title_In_English = $inenglish[34];
$Select_Days_Option_2_title_In_English = $inenglishday[0];
$Select_Days_Option_3_title_In_English = $inenglishday[1];
$Select_Days_Option_4_title_In_English = $inenglishday[2];
$Select_Days_Option_5_title_In_English = $inenglishday[3];
$Select_Days_Option_6_title_In_English = $inenglishday[4];
$Select_Days_Option_7_title_In_English = $inenglishday[5];
$Select_Days_Option_8_title_In_English = $inenglishday[6];




$title_name_in_german = $ingerman[41];
$name_title_in_german = $ingerman[36];
$email_title_in_german = $ingerman[20];
$phone_title_in_german = $ingerman[22];
$DOB_title_in_german = $ingerman[21];
$Place_to_go_title_In_german = $ingerman[3];
$Place_to_go_Option_1_title_In_german= $ingerman[42];
$Place_to_go_Option_2_title_In_german= $ingermanCat[2];
$Place_to_go_Option_3_title_In_german= $ingermanCat[0];
$Place_to_go_Option_4_title_In_german= $ingermanCat[1];
$Place_to_go_Option_5_title_In_german= $ingermanCat[3];
$Category_title_In_german = $ingerman[24];
$Category_Option_1_title_In_german=$ingerman[34];
$Category_Option_2_title_In_german=$ingermanCategory[0];
$Category_Option_3_title_In_german=$ingermanCategory[1];
$Category_Option_4_title_In_german=$ingermanCategory[2];
$Category_Option_5_title_In_german=$ingermanCategory[3];
$Available_title_In_german = $ingerman[9];
$Select_days_title_In_german = $ingerman[4];
$Message_title_In_german = $ingerman[38];
$Available_Timings_Option_1_title_In_german= $ingerman[31];

$Available_Timings_Option_2_title_In_german = $ingerman[0];
$Available_Timings_Option_3_title_In_german = $ingerman[1];
$Available_Timings_Option_4_title_In_german = $ingerman[2];

$Available_Timi_Option_2_title_In_german = $ingerman[32];
$Available_Timi_Option_3_title_In_german = $ingerman[33];
$Available_Timi_Option_4_title_In_german = $ingerman[34];

$Select_Days_Option_1_title_In_german = $ingerman[34];
$Select_Days_Option_2_title_In_german = $ingermanday[0];
$Select_Days_Option_3_title_In_german = $ingermanday[1];
$Select_Days_Option_4_title_In_german = $ingermanday[2];
$Select_Days_Option_5_title_In_german = $ingermanday[3];
$Select_Days_Option_6_title_In_german = $ingermanday[4];
$Select_Days_Option_7_title_In_german = $ingermanday[5];
$Select_Days_Option_8_title_In_german = $ingermanday[6];




$title_name_in = $alias[41];
$name_title_in = $alias[36];
$email_title_in = $alias[20];
$phone_title_in = $alias[22];
$DOB_title_in = $alias[21];
$Place_to_go_title_In = $alias[3];
$Place_to_go_Option_1_title_In =$alias[42];
$Place_to_go_Option_2_title_In =$aliasCat[2];
$Place_to_go_Option_3_title_In =$aliasCat[0];
$Place_to_go_Option_4_title_In =$aliasCat[1];
$Place_to_go_Option_5_title_In =$aliasCat[3];
$Category_title_In = $alias[24];
$Category_Option_1_title_In=$alias[34];
$Category_Option_2_title_In=$aliasCategory[0];
$Category_Option_3_title_In=$aliasCategory[1];
$Category_Option_4_title_In=$aliasCategory[2];
$Category_Option_5_title_In=$aliasCategory[3];
$Select_days_title_In = $alias[4];
$Message_title_In = $alias[38];
$Available_title_In = $alias[9];

$Available_Timings_Option_1_title_In= $alias[31];

$Available_Timings_Option_2_title_In = $alias[0];
$Available_Timings_Option_3_title_In = $alias[1];
$Available_Timings_Option_4_title_In = $alias[2];

$Available_Timi_Option_2_title_In = $alias[32];
$Available_Timi_Option_3_title_In = $alias[33];
$Available_Timi_Option_4_title_In = $alias[34];

$Select_Days_Option_1_title_In = $alias[34];
$Select_Days_Option_2_title_In = $aliasday[0];
$Select_Days_Option_3_title_In = $aliasday[1];
$Select_Days_Option_4_title_In = $aliasday[2];
$Select_Days_Option_5_title_In = $aliasday[3];
$Select_Days_Option_6_title_In = $aliasday[4];
$Select_Days_Option_7_title_In = $aliasday[5];
$Select_Days_Option_8_title_In = $aliasday[6];
                ...
                <div class="col-md-8  offset-md-2 ">
                         ...
                         <option id="" <?php if($value2=='first_aid_page'){echo 'selected';}?> value="first_aid_page">First Aid</option>
                           <option id="" <?php if($value2=='Vku_page'){echo 'selected';}?> value="Vku_page">VKU</option>                       
                                             ...
                                             <option id="" <?php if($value2=='about_us_page'){echo 'selected';}?> value="about_us_page">About Us</option> </a>
                                              <option id="" <?php if($value2=='Footer'){echo 'selected';}?> value="Footer_page">Footer</option> 
                       ...
                       <section id="section_select">
                        ...
                        <option id="" <?php if($value=='moto'){echo 'selected';}?> value="moto">MOTO</option>
                         <option id="" <?php if($value=='Footer'){echo 'selected';}?> value="Footer">Footer</option>
          ...
          <!-- VKU Page Form -->
            ...
            <div class="showHideForm" id="showHide-9">
                                            ...
                                            <div class="form-row">
                                                 ...
                                                 <!--    <label for="dob" class="col-form-label s-12">Button2 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php  echo $Banner_title;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Main Title In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="inenglish[]" value="<?php  echo $Banner_title_inenglish;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Main Title In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="ingerman[]" value="<?php  echo $Banner_title_ingerman;?>">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php  echo $Banner_desc;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Banner Desc In English</label>
                                                <textarea rows="5" cols="90" class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="inenglish[]" value=""><?php  echo $Banner_desc_inenglish;?></textarea>
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Banner Desc In German</label>
                                                <textarea rows="5" cols="90" class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="ingerman[]" value=""><?php  echo $Banner_desc_ingerman;?></textarea>
                                            </div>
...
<div class="showHideForm" id="showHide-15">
          ...
          <div><h2>Home Menu</h2></div>
                                             ...
                                             <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="day_alias_name[]"  value="<?php  echo $heading_1_title;?>">
                                                    
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 2 In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_inenglish[]" value="<?php  echo $heading_1_title_inenglish;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 2 In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_ingerman[]" value="<?php  echo $heading_1_title_ingerman;?>">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                 ...
                                                 <!--    <label for="dob" class="col-form-label s-12">Button1 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="day_alias_name[]" value="<?php  echo $heading_1_desc ;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 3 In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_inenglish[]" value="<?php  echo $heading_1_desc_inenglish;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 3 In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_ingerman[]" value="<?php  echo $heading_1_desc_ingerman;?>">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                 ...
                                                 <!--    <label for="dob" class="col-form-label s-12">Button2 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="day_alias_name[]" value="<?php  echo $heading_2_title ;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 4 In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_inenglish[]" value="<?php  echo $heading_2_title_inenglish;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 4 In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_ingerman[]" value="<?php  echo $heading_2_title_ingerman;?>">
                                            </div>
                                           ...
                                           <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="day_alias_name[]" value="<?php  echo $heading_2_desc;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 5 In English</label>
                                                 <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_inenglish[]" value="<?php  echo $heading_2_desc_inenglish;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 5 In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_ingerman[]" value="<?php  echo $heading_2_desc_ingerman;?>">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="day_alias_name[]" value="<?php  echo $mige_name_title;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 6 In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_inenglish[]" value="<?php  echo $mige_name_title_inenglish;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 6 In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_ingerman[]" value="<?php  echo $mige_name_title_ingerman;?>">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="day_alias_name[]" value="<?php  echo $mige_name_desc;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 7 In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_inenglish[]" value="<?php  echo $mige_name_desc_inenglish;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 7 In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_ingerman[]" value="<?php  echo $mige_name_desc_ingerman;?>">
                                            </div>
                          ...
                          <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="day_alias_name[]" value="<?php  echo $andrea;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 8 In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_inenglish[]" value="<?php  echo $andrea_inenglish;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 8 In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="day_ingerman[]" value="<?php  echo $andrea_ingerman;?>">
                                            </div>
...
<div class="mt-3"><h2>Sidebar Menu</h2></div>
         ...
         <!--  <div><h2>Page Name</h2></div> -->
                                             ...
                                             <!--    <label for="dob" class="col-form-label s-12">Title Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php  echo $title_name_in;?>">
                                            </div>
                                             ...
                                             <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $name_title_in;?>">
                                            ...
                                            <div class="form-row">
                                                 ...
                                                 <!--    <label for="dob" class="col-form-label s-12">Button1 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $email_title_in;?>" >
                                            </div>
                                            ...
                                            <div class="form-row">
                                                 ...
                                                 <!--    <label for="dob" class="col-form-label s-12">Button2 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $DOB_title_in;?>">
                                            </div>
                                           ...
                                           <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $phone_title_in;?>" >
                                            </div>
                                            ...
                                            <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $Place_to_go_title_In;?>">
                                            </div>
                                          ...
                                          <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $Category_title_In;?>" >
                                            </div>
                       ...
                       <div class="form-row">
                                          ...
                                          <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $Available_title_In;?>" >
                                            </div>
                                            ...
                                            <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]"value="<?php echo $Select_days_title_In;?>">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $Message_title_In;?>">
                                            </div>
                                            ...
                                            <div><h2>Available Timings</h2></div>
                                                <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]"value="<?php echo $Available_Timings_Option_1_title_In;?>">
                                            </div>
                                                <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 1 title  In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                             ...
                                             <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $Available_Timings_Option_2_title_In;?>">
                                            </div>
                                                  <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 2 title  In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="inenglish[]" value="<?php echo $Available_Timings_Option_2_title_In_English;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 2 title In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="ingerman[]" value="<?php echo $Available_Timings_Option_2_title_In_german;?>">
                                            </div>
                                                 ...
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $Available_Timings_Option_3_title_In;?>">
                                            </div>
                                               <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 3 title  In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="inenglish[]" value="<?php echo $Available_Timings_Option_3_title_In_English;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 3 title In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="ingerman[]" value="<?php echo $Available_Timings_Option_3_title_In_german;?>">
                                            </div>
                                          ...
                                          <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $Available_Timings_Option_4_title_In;?>">
                                            </div>
                                                         <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 4 title  In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="inenglish[]"value="<?php echo $Available_Timings_Option_4_title_In_English;?>">
                                            </div>
                                            
                                             <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 4 title In German</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="text" name="ingerman[]" value="<?php echo $Available_Timings_Option_4_title_In_german;?>">
                                            </div>
                                            ...
                                            <div><h2>Select Days</h2></div>
                                              <div class="form-row">
                                                 <div class="form-group mb-3">
                                                  <!--   <label for="dob" class="col-form-label s-12">Button3 Alias Name</label>  -->
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
                                                    type="hidden" name="alias_name[]" value="<?php echo $Select_Days_Option_1_title_In;?>">
                                            </div>
                                               <div class="form-group col-6 mb-3">
                                                <label for="dob" class="col-form-label s-12">Option 1 title  In English</label>
                                                <input class="form-control r-0 light s-12 datePicker" placeholder="" data-time-picker="false"
