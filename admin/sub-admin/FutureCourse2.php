...
$get_all_courses = get_all_future_course_detailv2($id,$date,$time,0);
             ...
             <!-- <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    ...
                    <li class="<?php if($_SESSION['SetTab']==2){echo 'a';}?>">
                        <a class="nav-link active"  href="PresentCourse2.php" ><i class="icon icon-circle-o"></i>Present  Course</a>
                    </li>
                    <li class="<?php if($_SESSION['SetTab']==3){echo 'a';}?>">
                        <a class="nav-link active"  href="#" ><i class="icon icon-circle-o"></i>Future  Course</a>
                    </li>
                </ul>
            </div> -->
             <div class="row justify-content-between">
                <ul class="d-flex" style="overflow-x: scroll;">
                    ...
                    <li style="min-width: 160px;"  class="<?php if($_SESSION['SetTab']==2){echo 'a';}?>">
                        <a class="nav-link active"  href="PresentCourse2.php" ><i class="icon icon-circle-o"></i>Present Courses</a>
                    </li>
                    <li style="min-width: 160px;"  class="<?php if($_SESSION['SetTab']==3){echo 'a';}?>">
                        <a class="nav-link active"  href="#" ><i class="icon icon-circle-o"></i>Future Courses</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <form>
                                    <table class="table table-striped table-hover r-0">
                                        ...
                                        <?php foreach ($records as $key) 
                                        {
                                            ...
                                            $date_time = date('d-m-Y',$course_date).' '.date('h:i a',$course_time);
                                            ?>
                                            <tr>
