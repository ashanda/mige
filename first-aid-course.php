            ...
            <section class="animatedParent service-form-bot" style="background: #e90616;">
				<div class="container">
					...
					<div class="row form-bokking animated bounceInRight slow">
						...
						<div class="col-md-3 btn-side-form"><a href="registration-form.php"><button type="submit" class="btn-primary book-on-red"><?php echo $translation['First_Aid_Page_Submit_Button']?></button></a></div>
					</div>
				</div>
            </section>
            <!--Services list-->
