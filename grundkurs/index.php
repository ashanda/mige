            ...
            <section class="motorcycle-cloth animatedParent" style="background: #fff;">
				<div class="container">
					...
					<div class="arr-box animated bounceInRight slow">
						<div class="table-item">
							<h5><?php echo $translation['_Vehicle_moto_cat_1_title_']?></h5>
							<p><?php echo $translation['A-2_wheeled_title_']?></p>
						</div>
						<div class="table-item">
							<h5><?php echo $translation['_Vehicle_moto_cat_2_title_']?></h5>
				...
				<div class="container">
					<div class="row animatedParent">
						...
						<div class="col-md-3 animated bounceInRight slow">
							<img src="<?=$config['base_url']?>/images/Partner_Hauptlin.png" />
						</div>
					</div>
				</div>
            </section>
            <section class="animatedParent service-form-bot" style="background: #e90616;">
				<div class="container">
					<div class="row form-bokking animated growIn slow" style="padding-top: 0px;">
						...
						<div class="col-md-3 btn-side-form"><a href="<?=$config['base_url']?>/book?>"><button type="submit" class="btn-primary book-on-red"><?php echo $translation['Moto_Book_course_Button']?></button></a></div>
					</div>
				</div>
            </section>
            <!--Services list-->
				...
				<div class="container">
					...
					<form class="trial-less animated growIn slow"  method="post">
						...
						<div class="form-group">
							...
							<input type="tel" class="form-control" id="number" maxlength="20" placeholder="<?php echo $translation['_Phone_title_']?>"  name="phone_no" min="0" />
						</div>
						<div class="form-group">
