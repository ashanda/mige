		...
		<div class="d-flex justify-content-between w-100">
			...
			<nav>
				<ul id="menu">
					...
					<a href="#VKU">VKU</a>
					<a href="#Moto">Moto</a></li>
					<a href="#Price">Price</a></li>
			...
			<div class="middle-1-de d-flex align-content-between flex-wrap">
			 <div class="w-100 text-center aos-item aos_bg">
			  ...
			  <div class="w-100 d-flex justify-content-center" id="adjust-more-info">
				...
				<a href="about.php" id="more-info"><button class="but-diff more-info">MORE</button></a>
			  </div>
			</div>
	...
	<div class="slide img_background_2 section" id="Drive_1">
		<div class="intro">
			...
			<div class="w-100 d-flex justify-content-center"  id="adjust-more-info">
				<a href="https://www.dharmani.com/FahrschuleStarWebSite/registration-form.php"><button class="but-red">REGISTRATION</button></a>
				<a href="#Contact"><button class="but-diff">CONTACT US</button></a>
				<a href="request-trial.php" id="more-info"><button class="but-diff more-info">MORE</button></a>
			  </div>
			</div>
    ...
    <div class="slide img_background_3 section" id="First-Aid_1">
		<div class="intro">
			...
			<div class="w-100 d-flex justify-content-center" id="adjust-more-info">
				<a href="https://www.dharmani.com/FahrschuleStarWebSite/registration-form.php"><button class="but-red">REGISTRATION</button></a>
				<a href="#Contact"><button class="but-diff">CONTACT US</button></a>
				<a href="first-aid-course.php" id="more-info"><button class="but-diff more-info">MORE</button></a>
			  </div>
			</div>
	...
	<div class="slide img_background_4 section" id="VKU_1">
		<div class="intro">
			...
			<div class="w-100 d-flex justify-content-center" id="adjust-more-info">
				<a href="https://www.dharmani.com/FahrschuleStarWebSite/registration-form.php"><button class="but-red">REGISTRATION</button></a>
				<a href="#Contact"><button class="but-diff">CONTACT US</button></a>
				<a href="vku.php" id="more-info"><button class="but-diff more-info">MORE</button></a>
		    </div>
			</div>
	...
	<div class="slide img_background_5 section" id="Moto_1">
		<div class="intro">
			...
			<div class="w-100 d-flex justify-content-center" id="adjust-more-info">
				<a href="https://www.dharmani.com/FahrschuleStarWebSite/registration-form.php"><button class="but-red">REGISTRATION</button></a>
				<a href="#Contact"><button class="but-diff">CONTACT US</button></a>
				<a href="motorcycle.php" id="more-info"><button class="but-diff more-info">MORE</button></a>
			  </div>
			</div>
	...
	<div class="slide img_background_6 section" id="Price_1">
		<div class="intro">
			...
			<div class="w-100 d-flex justify-content-center" id="adjust-more-info">
				<a href="https://www.dharmani.com/FahrschuleStarWebSite/registration-form.php"><button class="but-red">REGISTRATION</button></a>
				<a href="#Contact"><button class="but-diff">CONTACT US</button></a>
				<a href="pricing.php" id="more-info"><button class="but-diff more-info">MORE</button></a>
			  </div>
			</div>
...
<script type="text/javascript" src="include/js/fullpage1.js"></script>
...
<script>
$(".header-designed-2, .select_li").click(function(){
