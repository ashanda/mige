			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="pricing-plan box-shadow">
						...
						<div class="plan-button">
							<a href="<?=$config['base_url']?>/request-trial.php" class="btn btn-outline-darkgrey"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $translation['plan_button_1']?></font></font></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					...
					<div class="pricing-plan box-shadow">
						...
						<div class="plan-button">
							<a href="<?=$config['base_url']?>/request-trial.php" class="btn btn-outline-darkgrey"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $translation['plan_button_2']?></font></font></a>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					...
					<div class="pricing-plan box-shadow">
						...
						<div class="plan-button">
							<a href="<?=$config['base_url']?>/request-trial.php" class="btn btn-outline-darkgrey"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $translation['plan_button_3']?></font></font></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="pricing-plan box-shadow">
						...
						<div class="plan-button">
							<a href="<?=$config['base_url']?>/registration-form.php" class="btn btn-outline-darkgrey"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $translation['plan_button_4']?></font></font></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="pricing-plan box-shadow">
						...
						<div class="plan-button">
							<a href="<?=$config['base_url']?>/registration-form.php" class="btn btn-outline-darkgrey"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $translation['plan_button_5']?></font></font></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="pricing-plan box-shadow">
						...
						<div class="plan-button">
							<a href="<?=$config['base_url']?>/registration-form.php" class="btn btn-outline-darkgrey"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $translation['plan_button_6']?></font></font></a>
						</div>
					</div>
				</div>
			</div>
