					...
					<form class="registration-form">
						...
						<div id="step4" class="animated bounceInRight slow">
							...
							<div class="bottom-buttons">
								...
								<a href="booking-page-form.php" class="btns next-button adddisable" id="review-done" type="button" ><?php echo $translation['_continue_Title_']?></a>
							</div>
						</div>
		 ...
		 console.log(data);
		    if(data.status==1)
		    {
		    	...
		    	$.each(data.data, function(key, value) {
		    		$(".motor-cate").append('<div class="sub-cate" id="sub_category'+value.id+'" value="'+value.id+'"><div class="img-side"><img src="images/motor.png"></div><div class="mot-des"><h5>'+value.name+'</h5><p>'+value.description+'</p></div></div>');
		    	});
