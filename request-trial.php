				...
				<div class="container">
					...
					<form class="trial-less" method="post">
						...
						<div class="form-group">
							...
							<input type="tel" class="form-control" id="number"  maxlength="20" name="phone_no" min="0" oninput="validity.valid||(value='');" />
						</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<ul class="multi-select select-day" >
								<li><input type="checkbox" class="s-all1" id="select_all1" /><?php echo $translation['_Select_all_title_']?></li> 
