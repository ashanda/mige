                ...
                <div class="container">
                    ...
                    <div class="row animated bounceInRight slow course-items">
                        <div class="col-md-3 col-sm-6 col-xs-12 mars">
                           ...
                           <div class="col-md-3 btn-side-form"><a href=" <?=$config['base_url']?>/registration-form.php"><button type="submit" class="book-on-blue"><?php echo $translation['Button_BOOK_VKU_1']?></button></a></div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mars">
                            <div class="service-content">
                                ...
                                <div class="col-md-3 btn-side-form"><a href=" <?=$config['base_url']?>/registration-form.php"><button type="submit" class="book-on-blue"><?php echo $translation['Button_BOOK_VKU_2']?></button></a></div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mars">
                            <div class="service-content">
                            ...
                            <div class="col-md-3 btn-side-form"><a href=" <?=$config['base_url']?>/registration-form.php"><button type="submit" class="book-on-blue"><?php echo $translation['Button_BOOK_VKU_3']?></button></a></div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mars">
                            <div class="service-content">
                                ...
                                <p><?php echo $translation['_driving_title_']?></p>
                                 <div class="col-md-3 btn-side-form"><a href="   <?=$config['base_url']?>/registration-form.php"><button type="submit" class="book-on-blue"><?php echo $translation['Button_BOOK_VKU_4']?></button></a></div>
                            </div>
                        </div>
                    </div> 
                </div>
            ...
            <section class="animatedParent service-form-bot" style="background: #e90616;">
                <div class="container">
                    <div class="row form-bokking animated bounceInRight slow" style="padding-top: 0px;">
                        ...
                        <div class="col-md-3 btn-side-form"><a href="registration-form.php"><button type="submit" class="btn-primary book-on-red"><?php echo $translation['_book_vku_button_']?></button></a></div>
